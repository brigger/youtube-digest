...
<head>
  ...
  <style>
    ...
    .toc ul li > a {{ font-family:Helvetica,Arial,sans-serif; font-size:18px; font-weight:700; color:#4a6fa5; text-decoration:none; }}
    ...
    .toc-items li a {{ font-size:12px; font-weight:400; color:#555; text-decoration:underline; }}
    .toc-items li a:hover {{ color:#4a6fa5; }}
